  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& .MuiSwitch-thumb:before': {
        backgroundImage: `url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" height="${smaller ? 15 : 20}" width="${smaller ? 15 : 20}" viewBox="0 0 20 20"><path fill="${encodeURIComponent(
          '#fff',
...
const ColourModeSwitch = ({ margin } : { margin?: string }) => {
