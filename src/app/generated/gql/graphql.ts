...
export type AdminItemsFragment = { __typename: 'User', id: string, name: string, year?: number | null, class?: string | null, email: string, status: UserStatus, role: UserRole };
...
export type GetAdminsQuery = { __typename: 'Query', getUsers: { __typename: 'UserOffsetPaginationResponse', records: Array<{ __typename: 'User', id: string, name: string, year?: number | null, class?: string | null, email: string, status: UserStatus, role: UserRole }>, pageInfo: { __typename: 'OffsetPaginationPageInfo', totalRowCount: number, pageCount: number } } };
...
export type StudentItemsFragment = { __typename: 'User', id: string, name: string, year?: number | null, class?: string | null, number?: number | null, email: string, status: UserStatus, role: UserRole };
...
export type TeacherItemsFragment = { __typename: 'User', id: string, name: string, year?: number | null, class?: string | null, email: string, status: UserStatus, role: UserRole };
...
export const FindMyPasswordDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"FindMyPassword"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"email"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"findPassword"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"email"},"value":{"kind":"Variable","name":{"kind":"Name","value":"email"}}}]}]}}]} as unknown as DocumentNode<FindMyPasswordQuery, FindMyPasswordQueryVariables>;
